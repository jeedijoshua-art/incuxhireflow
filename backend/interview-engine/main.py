...
def run_interview_simulation(resume_text: str, target_role: str, interactive: bool = False, max_questions: int = 3):
    # 1. Initialize State
    ...
    while not flow.is_complete():
        ...
        # Generate question
        if q_idx == 1:
            # Traditional first question
            question = f"Hi, thank you for coming in today. To get started, please tell me a little about yourself, highlighting your key experiences."
        else:
            question = generator.generate_question(
                resume_text=flow.state.resume_text,
        ...
        # Evaluate Answer
        eval_result = evaluator.evaluate_answer(question, answer, target_role)
        flow.record_evaluation(eval_result.model_dump())
        ...
        print(f"Analysis: {eval_result.explanation}")

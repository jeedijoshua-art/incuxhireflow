...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto w-full min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        {[
          ...
          <motion.div key={stat.label} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.1 }} className="p-5 bg-zinc-900 border border-white/[0.06] rounded-xl text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="bg-zinc-900 border border-white/[0.06] rounded-xl p-6">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="bg-zinc-900 border border-white/[0.06] rounded-xl p-6">

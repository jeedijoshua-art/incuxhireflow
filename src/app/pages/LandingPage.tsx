        ...
        <FadeUp>
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-zinc-400 text-lg leading-relaxed">
              HireFlow is an AI-powered Interview and Resume Intelligence
              platform designed to help candidates prepare for real-world
              interviews. Through intelligent AI interview simulations and
              performance analytics, candidates receive actionable insights to
...
function DevelopersSection() {
  ...
  return (
    <section
      id="developers"
      className="py-24 relative border-t border-white/[0.04] bg-transparent"
    >
      <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
        <FadeUp>
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400">
              The team powering the intelligence behind HireFlow.
            </p>
          </div>
        </FadeUp>
        ...
        <FadeUp delay={0.4}>
          <div className="mt-20 text-center max-w-2xl mx-auto bg-[rgba(10,15,25,0.72)] border border-[rgba(45,212,191,0.08)] rounded-3xl p-8 backdrop-blur-md shadow-[0_0_15px_rgba(45,212,191,0.05)]">
            ...
            <p className="text-zinc-400 mb-8">
              Explore our developer portfolio and learn more about the team
              behind HireFlow.
            </p>
            <a
...
function FaqSection() {
  ...
  const faqs = [
    {
      q: "What is HireFlow?",
      a: "HireFlow is an AI-powered interview platform that simulates real-world interview conditions to help you practice, refine your communication, and gain confidence.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes! Uploading your resume allows the AI to tailor the interview exactly to your experience and the specific roles you are targeting.",
    },
    {
      q: "Can I practice multiple interviews?",
      a: "Absolutely. You can run as many interviews as you need to perfect your pitch and prepare for different roles.",
    },
    {
          ...
          {faqs.map((faq, idx) => (
            <FadeUp key={idx} delay={0.1 * idx}>
              <div className="bg-[rgba(10,15,25,0.72)] border border-[rgba(45,212,191,0.08)] shadow-[0_0_15px_rgba(45,212,191,0.05)] rounded-2xl overflow-hidden backdrop-blur-md transition-colors hover:bg-zinc-900/60">
                ...
                >
                  <span className="text-zinc-100 font-medium pr-4">
                    {faq.q}
                  </span>
                  <ChevronDown
